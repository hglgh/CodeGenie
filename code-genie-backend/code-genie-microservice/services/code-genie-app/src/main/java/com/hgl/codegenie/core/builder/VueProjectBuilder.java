package com.hgl.codegenie.core.builder;
 ...
 *
 * @Package: com.hgl.codegeniebackend.core.builder
 * @Description:
 * @Author HGL
 * @Create: 2025/8/7 11:02
 */
@Slf4j
@Component
public class VueProjectBuilder {
    ...
    /**
     * 异步构建项目（不阻塞主流程） Java 21 的虚拟线程特性
     *
     * @param projectPath 项目路径
     */
    public void buildProjectAsync(String projectPath) {
        // 在单独的线程中执行构建，避免阻塞主流程
        Thread.ofVirtual().name(String.format("vue-builder-%s", System.currentTimeMillis())).start(() -> {
            try {
