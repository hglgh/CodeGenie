...
import com.hgl.codegenie.model.message.StreamMessage;
...
import com.hgl.codegenie.tools.BaseTool;
...
public class JsonMessageStreamHandler {
    ...
    public Flux<String> handle(Flux<String> originFlux, ChatHistoryService chatHistoryService, long appId, User loginUser) {
        ...
        return originFlux
                // 解析每个 JSON 消息块
                .mapNotNull(chunk -> handleJsonMessageChunk(chunk, chatHistoryStringBuilder, seenToolIds))
                // 过滤空字串
