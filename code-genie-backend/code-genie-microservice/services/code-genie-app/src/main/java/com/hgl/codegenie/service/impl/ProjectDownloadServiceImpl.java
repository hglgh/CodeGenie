...
public class ProjectDownloadServiceImpl implements ProjectDownloadService {
    ...
    public void downloadProjectAsZip(String projectPath, String downloadFileName, HttpServletResponse response) {
        ...
        /*
         * projectDir.exists() - 检查路径是否存在
         * projectDir.isDirectory() - 检查是否为目录
         * projectDir.isFile() - 检查是否为文件
         */
     ...
     * 检查路径是否允许包含在压缩包中
     *
     * @param projectRoot 项目根目录  例如"/home/user/myproject"
     * @param fullPath    完整路径   "/home/user/myproject/src/main.java"正常文件，"/home/user/myproject/node_modules"被忽略
     * @return 是否允许
     */
